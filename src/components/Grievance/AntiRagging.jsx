...
import { antiRagData } from '../../data/data';
                ...
                >
                    <table className="w-full border-collapse bg-white">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {antiRagData.map((antiRag, index) => (
                                <tr
                                    key={antiRag.id}
                                    className={`${index % 2 === 0 ? "bg-white" : "bg-gray-50"} hover:bg-blue-50/50 transition-colors duration-200`}
                                >
                                    <td className="px-6 py-4 text-gray-700 font-medium border-r border-gray-200">{antiRag.id}.</td>
                                    <td className="px-6 py-4 text-gray-700 font-medium border-r border-gray-200">{antiRag.name}</td>
                                    <td className="px-6 py-4 text-gray-600 border-r border-gray-200">{antiRag.designation}</td>
                                    <td className="px-6 py-4 text-gray-600 font-medium border-r border-gray-200">{antiRag.appointedAs}</td>
                                    <td className="px-6 py-4 text-gray-600 font-medium border-r border-gray-200">{antiRag.mobile}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>

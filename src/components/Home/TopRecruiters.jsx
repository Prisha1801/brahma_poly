...
const recruiters = [
    { name: "Google", file: "google.png", sector: "Technology" },
    { name: "Infosys", file: "infosys.png", sector: "IT Services" },
    { name: "iPower", file: "ipower.png", sector: "Engineering" },
    { name: "Larsen & Toubro", file: "larsen.png", sector: "Infrastructure" },
    { name: "Revival", file: "revival.png", sector: "Manufacturing" },
    { name: "Siemens", file: "siemens.png", sector: "Automation" },
    { name: "Simpolo", file: "simpolo.png", sector: "Ceramics" },
    { name: "Tata Motors", file: "tata motors.png", sector: "Automobile" },
    { name: "Teknoflow", file: "teknoflow.png", sector: "Engineering" },
    { name: "U Company", file: "u.png", sector: "Industrial" },
    { name: "Vaishnavi Auto", file: "vaishnavi auto.png", sector: "Automobile" },
    { name: "Wipro", file: "wipro.png", sector: "IT Services" },
];
